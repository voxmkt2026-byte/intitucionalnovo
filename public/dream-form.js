...
(function () {
  ...
  function injectStyles(theme) {
    ...
    var css = [
      ...
      '.df-section .df-kicker{text-align:center;text-transform:uppercase;letter-spacing:.15em;font-size:.75rem;font-weight:700;color:#d4a017;margin-bottom:.5rem;font-family:Inter,sans-serif}',
      ...
      '.df-progress span.active{background:#d4a017}',
      ...
      '.df-label{display:block;font-size:.65rem;font-weight:700;text-transform:uppercase;letter-spacing:.12em;color:#d4a017;margin-bottom:.4rem;font-family:Inter,sans-serif}',
      ...
      '.df-input:focus{border-color:#d4a017;box-shadow:0 0 0 3px rgba(212,160,23,.15)}',
      ...
      '.df-range::-webkit-slider-thumb{-webkit-appearance:none;width:22px;height:22px;border-radius:50%;background:#d4a017;cursor:pointer;box-shadow:0 2px 8px rgba(212,160,23,.3)}',
      '.df-range::-moz-range-thumb{width:22px;height:22px;border-radius:50%;background:#d4a017;cursor:pointer;border:none}',
      ...
      '.df-range-value{color:#d4a017;font-weight:700;font-size:1.1rem}',
      '.df-btn{display:flex;align-items:center;justify-content:center;gap:.5rem;width:100%;padding:1rem;border:none;border-radius:.75rem;background:linear-gradient(135deg,#d4a017,#e8b82e);color:#111;font-size:.9rem;font-weight:700;cursor:pointer;transition:all .2s;font-family:Inter,sans-serif;margin-top:.25rem;box-shadow:0 4px 16px rgba(212,160,23,.2)}',
      '.df-btn:hover{transform:translateY(-1px);box-shadow:0 6px 20px rgba(212,160,23,.3)}',
