...
async function runMigration() {
  ...
  try {
    ...
    // Prospecção outbound: tabelas independentes dos leads de campanhas.
    await sql`
    ...
    `;
    await sql`CREATE INDEX IF NOT EXISTS prospect_events_prospect_idx ON prospect_events (prospect_id, criado_em DESC)`;
